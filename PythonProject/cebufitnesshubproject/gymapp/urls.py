...
urlpatterns = [
    ...
    path('staff/deactivate-member/', deactivate_member_view, name='deactivate_member_view'),
    path('staff/reactivate-member/', reactivate_member_view, name='reactivate_member_view'),
